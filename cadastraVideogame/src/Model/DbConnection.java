...
public class DbConnection {
    ...
    //                                     ↓      ↓          ↓ 
    private final String SQLITEURL = "jdbc:sqlite:src/resources/videogame.db";

    // String de conexão com o banco de dados MySQL
    //                                   tipo    servidor  porta database   usuário       senha
    //                                    ↓       ↓         ↓     ↓           ↓             ↓ 
    private final String MYSQLURL = "jdbc:mysql://localhost:3306/videogame?user=root&password=root";

    // String de conexão com o banco de dados PostGreeSQL
    //                                      tipo         servidor  porta database   usuário      senha
    //                                       ↓            ↓         ↓     ↓           ↓             ↓       
    private final String POSTGREEURL = "jdbc:postgresql://localhost:5432/videogame?user=root&password=root";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (res.next()) {
                ...
                System.out.println("  Título: " + res.getString("t_title"));
                System.out.println("  Plataforma: " + res.getString("t_plataforma"));
                System.out.println("  Midia: " + res.getString("t_midia"));
                System.out.println("  Sinopse: " + res.getString("t_sinopse"));
